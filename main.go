...
func main() {
	chain := getEnvDefault("LIQUID_CHAIN", "liquid-mainnet")
	liquidUser := getEnvDefault("LIQUID_RPC_USER", "")
	liquidPass := getEnvDefault("LIQUID_RPC_PASS", "")
	liquidHost := getEnvDefault("LIQUID_RPC_HOST", "")
	interval := getEnvDefault("LIQUID_INTERVAL", "15")
